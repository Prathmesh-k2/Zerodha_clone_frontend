  ...
  return (
     <div className="container">
      <div className="row p-3 mt-3  border-top">
        ...
        <div className="row p-3 text-muted align-items-center"
        style={{lineHeight:"1.7",fontSize:"1.05em"}}>
            <div className="col-12 col-md-6 p-3 p-md-5 text-center mb-4 mb-md-0">
          <img src="/media/images/nithinKamath.jpg"
          alt="Nitin Kamath"
          className="img-fluid"
          style={{borderRadius:"100%", width:"60%", maxWidth:"220px"}} />
          <h4 className="mt-4">
             Nitin Kamath
          </h4>
          <h6>
